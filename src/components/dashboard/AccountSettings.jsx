      ...
      <Card className="card-custom">
        ...
        <Card.Body>
          <div className="row">
            ...
            <div className="col-md-6 mb-3">
              <strong>Last Login:</strong> 2024-01-15 10:30 AM
            </div>
            <div className="col-md-6 mb-3">
              <strong>Account Created:</strong> 2024-01-01
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-muted small mb-3">
              Need help with your account? Contact the administrator or use our chatbot for assistance.
            </p>
