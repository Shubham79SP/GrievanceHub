        ...
        <Container fluid>
          ...
          <div className="d-flex align-items-center">
            <div className="position-relative me-3">
              <Button variant="outline-warning" size="sm" className="position-relative">
              ...
              <Card.Body className="p-0">
                ...
                <div className="p-3 border-bottom">
                  ...
                  <div className="small">
                    ...
                    <div className="mb-1">
                      <strong>Department:</strong> {adminData.department}
                    </div>
                    <div className="mb-1">
                ...
                <Nav className="flex-column">
                  ...
                  >
                    ...
                    User Management
                    {pendingApprovals > 0 && (
                      <Badge bg="warning" pill className="ms-2" style={{ fontSize: "0.6rem" }}>
                        {pendingApprovals}
                      </Badge>
                    )}
                  </Nav.Link>
